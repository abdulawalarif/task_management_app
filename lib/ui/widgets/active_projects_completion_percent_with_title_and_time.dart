...
class ActiveProjectsCompletionPercentWithTitleAndTime extends StatelessWidget {
  ...
  const ActiveProjectsCompletionPercentWithTitleAndTime({super.key,
  ...
  double  percentNumberInCircularView  = percentOFWorkCompleted / 100.0; // Convert to a decimal
      ...
      child: Column(
        ...
        children: [
          CircularPercentIndicator(
            ...
            center: Center(
              child: Text("$percentOFWorkCompleted%", style: TextStyle(
                color: Colors.white,
          ...
          Column(
            ...
            overflow: TextOverflow.ellipsis,
              ...
              Gap(.5.h),
              Text("$timeContinueOfProject hours progress", style: TextStyle(color: Colors.white54),)],
          )
        ],
      ),
    );
